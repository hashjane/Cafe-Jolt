...
class MenuItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post menu_items_url, params: { menu_item: { description: @menu_item.description, id: @menu_item.id, kind: @menu_item.kind, name: @menu_item.name, stock_level: @menu_item.stock_level } }
    end
  ...
  test "should update menu_item" do
    patch menu_item_url(@menu_item), params: { menu_item: { description: @menu_item.description, id: @menu_item.id, kind: @menu_item.kind, name: @menu_item.name, stock_level: @menu_item.stock_level } }
